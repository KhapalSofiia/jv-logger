...
public class OrderServiceImpl implements OrderService {
    private static final Logger logger = LogManager.getLogManager().getLogger(OrderServiceImpl.class.getName());
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("Data was successfully retrieved from DB for userId: " + userId);
        return products;
    }
}
